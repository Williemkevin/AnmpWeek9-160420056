...
val MIGRATION_2_3 = object : Migration(2, 3) {
    ...
    //Penggunaan tipe variabel Int agar nilai is_done tidak terbatas hanya 2 nilai saja, misalnya nilainya bisa 'belum dikerjakan', 'sedang dikerjakan', 'sudah selesai'. Jika menggunakan Boolean hanya akan terbatas 2 nilai saja yaitu True atau False
    }
}
